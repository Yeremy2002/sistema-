                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <h5>Total</h5>
                                    <h3 class="text-primary">S/. {{ number_format($reserva->total, 2) }}</h3>
                                </div>
                                <div class="col-md-4 text-center">
                                    <h5>Adelanto</h5>
                                    <h3 class="text-success">S/. {{ number_format($reserva->adelanto, 2) }}</h3>
                                </div>
                                <div class="col-md-4 text-center">
                                    <h5>Pendiente</h5>
                                    <h3 class="text-danger">S/. {{ number_format($reserva->pendiente, 2) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
