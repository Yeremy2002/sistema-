...
@section('content')
    ...
    <div id="feedback_habitacion" class="mt-2"></div>
@stop
...
@section('js')
    <script>
        ...
        // Feedback en tiempo real para campos obligatorios
        document.getElementById('numero').addEventListener('input', function() {
            this.classList.remove('is-invalid');
            document.getElementById('feedback_habitacion').innerHTML = '';
        });
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!numero || !categoria || !nivel || !precio) {
                errorMsg = 'Todos los campos obligatorios deben estar completos.';
            }
            // Aquí podrías agregar una validación AJAX para número de habitación único
            if (errorMsg) {
                e.preventDefault();
                Swal.fire({
                    icon: 'error',
                    title: 'Error en la habitación',
                    text: errorMsg
                });
            }
        });
