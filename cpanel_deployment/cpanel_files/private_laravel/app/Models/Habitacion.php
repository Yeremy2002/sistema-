...
class Habitacion extends Model
{
    ...
    // NUEVO: Métodos para saber si la habitación está reservada-pendiente o reservada-confirmada
    public function isReservadaPendiente()
    {
        return $this->estado === 'Reservada-Pendiente';
    }
    public function isReservadaConfirmada()
    {
        return $this->estado === 'Reservada-Confirmada';
    }
