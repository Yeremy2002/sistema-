...
class CajaPolicy
{
    ...
    {
        // El usuario puede actualizar (cerrar) la caja si es suya o si tiene permiso de cerrar cajas
        return ($user->id === $caja->user_id && $caja->estado) || $user->hasPermissionTo('cerrar caja');
    }
